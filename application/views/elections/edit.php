							...
							<div class="card-body">
								<form method="POST" action="" enctype="multipart/form-data">
									<div class="form-group">
										...
										<input class="form-control" name="judul" type="text" value="<?= $election->title;?>"/>
									</div>
									<div class="form-group">
										<label for="date-range">Waktu Mulai</label>
										<input type="text" class="form-control datetimepicker" name="mulai" value="<?= $election->start_at;?>" />
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-12 col-md-7">
											<div id="image-preview" class="image-preview">
												...
												<input type="hidden" name="image_hidden" value="<?= $election->image;?>"/>
											</div>
										</div>
									</div>
									<div class="form-group">
										<label for="deskripsi">Deskripsi</label>
										<textarea class="form-control summernote-simple" name="deskripsi"><?= $election->description;?></textarea>
									</div>
